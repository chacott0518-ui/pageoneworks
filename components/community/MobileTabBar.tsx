...
export function MobileTabBar({ onWrite }: { onWrite: () => void }) {
  ...
  return (
    <>
      <nav
        className="min-[1200px]:hidden fixed bottom-0 left-0 right-0 grid grid-cols-5"
        style={{
          height: '56px',
          zIndex: 100,
        ...
        <div className="flex flex-col items-center justify-center">
          <button
            ...
            style={{
              ...
              height: '44px',
              borderRadius: '50%',
              background: COMMUNITY_COLORS.gold,
          ...
          <span className="text-[9px] font-medium mt-0.5" style={{ color: COMMUNITY_COLORS.meta }}>
            글쓰기
          </span>
        </div>
      ...
      <div className="min-[1200px]:hidden" style={{ height: '56px' }} />
    </>
  )
}
